...
export default function SignUpForm({ onSubmit, loginImage }: SignUpFormProps) {
  const {
    control,
    handleSubmit,
    formState: { errors },
  ...
  const onHandleSubmit = (data: SignupFormInputs) => {
    onSubmit(data);
  };
    ...
    <ThemeProvider theme={defaultTheme}>
      <Grid container component="main" sx={{ height: "100vh" }}>
            ...
            <SvgIcon>
              ...
              >
                <g id="XMLID_9_">
                  <path
                    id="XMLID_10_"
                    d="M169.392,199.395c-5.858,5.857-5.858,15.355,0,21.213c2.929,2.929,6.767,4.394,10.607,4.394
		...
		c-5.858,5.858-5.858,15.355,0,21.213l19.393,19.394H15c-8.284,0-15,6.716-15,15s6.716,15,15,15h173.785L169.392,199.395z"
                  ...
                  <path
                    id="XMLID_11_"
                    d="M207.301,42.3c-40.945,0-79.04,20.312-101.903,54.333c-4.621,6.876-2.793,16.196,4.083,20.816
		...
		S274.958,42.3,207.301,42.3z"
            ...
            <Typography variant="body2" color="black" align="center">
              <Link color="inherit" href="/signIn" style={{ color: "black" }}>
